...
<main class="container">
    ...
    <div class="produtos">
        ...
        <div class="destaques-destilados">
            <ul>
                <?php
                $queryCategoria = "SELECT idCategoria FROM ADG2L_Categorias WHERE nomeCategoria = 'Destilados'";
                ...
                if ($categoria) {
                    ...
                    if (count($produtos) > 0) {
                        foreach ($produtos as $produto): ?>
                            <li class="card-produto" data-category="destilados">
                    ...
                    echo "<p>Categoria 'Destilados' não encontrada.</p>";
                }
                ?>
            </ul> 
