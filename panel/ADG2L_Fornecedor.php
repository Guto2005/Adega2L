 ...
 */
    ...
    class ADG2L_Fornecedor_ADG2L_ProdutosPage extends DetailPage
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_ADG2L_Fornecedor_ADG2L_Produtos_idCategoria_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idCategoria', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_ADG2L_Fornecedor_ADG2L_Produtos_idCategoria_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_ADG2L_Fornecedor_ADG2L_Produtos_idFornecedor_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idFornecedor', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_ADG2L_Fornecedor_ADG2L_Produtos_idFornecedor_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Id Categoria', 'idCategoria', 'idCategoria_nomeCategoria', 'edit_ADG2L_Fornecedor_ADG2L_Produtos_idCategoria_search', $editor, $this->dataset, $lookupDataset, 'idCategoria', 'nomeCategoria', '');
            ...
            $editColumn = new DynamicLookupEditColumn('Id Fornecedor', 'idFornecedor', 'idFornecedor_nomeFornecedor', 'edit_ADG2L_Fornecedor_ADG2L_Produtos_idFornecedor_search', $editor, $this->dataset, $lookupDataset, 'idFornecedor', 'nomeFornecedor', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nomeCategoria', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Categoria', 'idCategoria', 'idCategoria_nomeCategoria', 'multi_edit_ADG2L_Fornecedor_ADG2L_Produtos_idCategoria_search', $editor, $this->dataset, $lookupDataset, 'idCategoria', 'nomeCategoria', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('nomeFornecedor', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Fornecedor', 'idFornecedor', 'idFornecedor_nomeFornecedor', 'multi_edit_ADG2L_Fornecedor_ADG2L_Produtos_idFornecedor_search', $editor, $this->dataset, $lookupDataset, 'idFornecedor', 'nomeFornecedor', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nomeCategoria', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Categoria', 'idCategoria', 'idCategoria_nomeCategoria', 'insert_ADG2L_Fornecedor_ADG2L_Produtos_idCategoria_search', $editor, $this->dataset, $lookupDataset, 'idCategoria', 'nomeCategoria', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('nomeFornecedor', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Fornecedor', 'idFornecedor', 'idFornecedor_nomeFornecedor', 'insert_ADG2L_Fornecedor_ADG2L_Produtos_idFornecedor_search', $editor, $this->dataset, $lookupDataset, 'idFornecedor', 'nomeFornecedor', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('nomeCategoria', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_ADG2L_Fornecedor_ADG2L_Produtos_idCategoria_search', 'idCategoria', 'nomeCategoria', null, 20);
            ...
            $lookupDataset->setOrderByField('nomeFornecedor', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_ADG2L_Fornecedor_ADG2L_Produtos_idFornecedor_search', 'idFornecedor', 'nomeFornecedor', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nomeCategoria', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_ADG2L_Fornecedor_ADG2L_Produtos_idCategoria_search', 'idCategoria', 'nomeCategoria', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nomeFornecedor', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_ADG2L_Fornecedor_ADG2L_Produtos_idFornecedor_search', 'idFornecedor', 'nomeFornecedor', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nomeCategoria', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_ADG2L_Fornecedor_ADG2L_Produtos_idCategoria_search', 'idCategoria', 'nomeCategoria', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nomeFornecedor', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_ADG2L_Fornecedor_ADG2L_Produtos_idFornecedor_search', 'idFornecedor', 'nomeFornecedor', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nomeCategoria', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_ADG2L_Fornecedor_ADG2L_Produtos_idCategoria_search', 'idCategoria', 'nomeCategoria', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nomeFornecedor', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_ADG2L_Fornecedor_ADG2L_Produtos_idFornecedor_search', 'idFornecedor', 'nomeFornecedor', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class ADG2L_FornecedorPage extends Page
    {
        protected function DoBeforeCreate()
        {
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'nomeFornecedor', 'nomeFornecedor', 'Nome Fornecedor'),
                new FilterColumn($this->dataset, 'contatoTel', 'contatoTel', 'Contato Tel'),
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('contatotel_edit');
            ...
            $main_editor = new TextEdit('cnpj_edit');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('ADG2L_Fornecedor.ADG2L_Produtos')->HasViewGrant() && $withDetails)
            {
            //
            // View column for ADG2L_Fornecedor_ADG2L_Produtos detail
            //
            $column = new DetailColumn(array('idFornecedor'), 'ADG2L_Fornecedor.ADG2L_Produtos', 'ADG2L_Fornecedor_ADG2L_Produtos_handler', $this->dataset, 'ADG2 L Produtos');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
            ...
            $grid->AddViewColumn($column);
            //
            // View column for contatoTel field
            //
            $column = new TextViewColumn('contatoTel', 'contatoTel', 'Contato Tel', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            //
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editor->SetMaxLength(45);
            $editColumn = new CustomEditColumn('Nome Fornecedor', 'nomeFornecedor', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for contatoTel field
            //
            $editor = new TextEdit('contatotel_edit');
            $editor->SetMaxLength(9);
            $editColumn = new CustomEditColumn('Contato Tel', 'contatoTel', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            $detailPage = new ADG2L_Fornecedor_ADG2L_ProdutosPage('ADG2L_Fornecedor_ADG2L_Produtos', $this, array('idFornecedor'), array('idFornecedor'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('ADG2L_Fornecedor.ADG2L_Produtos'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('ADG2L_Fornecedor.ADG2L_Produtos'));
            $detailPage->SetHttpHandlerName('ADG2L_Fornecedor_ADG2L_Produtos_handler');
            $handler = new PageHTTPHandler('ADG2L_Fornecedor_ADG2L_Produtos_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
    ...
    try
    {
        $Page = new ADG2L_FornecedorPage("ADG2L_Fornecedor", "ADG2L_Fornecedor.php", GetCurrentUserPermissionsForPage("ADG2L_Fornecedor"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("ADG2L_Fornecedor"));
