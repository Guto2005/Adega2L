 ...
 */
    ...
    class clientesPage extends Page
    {
        ...
        {
            $this->SetTitle('Projeto Clientes');
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'cli_nome', 'cli_nome', 'Cli Nome'),
                new FilterColumn($this->dataset, 'cli_bairro', 'cli_bairro', 'Cli Bairro'),
                new FilterColumn($this->dataset, 'cli_cidade', 'cli_cidade', 'Cli Cidade'),
                new FilterColumn($this->dataset, 'cli_end', 'cli_end', 'Cli End'),
                new FilterColumn($this->dataset, 'cli_telefone', 'cli_telefone', 'Cli Telefone')
            );
        }
        ...
        {
            $main_editor = new TextEdit('cli_id_edit');
            ...
            $main_editor = new TextEdit('cli_nome_edit');
            ...
            $main_editor = new TextEdit('cli_bairro_edit');
            ...
            $main_editor = new TextEdit('cli_cidade_edit');
            ...
            $main_editor = new TextEdit('cli_end_edit');
            ...
            $main_editor = new TextEdit('cli_telefone_edit');
            $main_editor->SetMaxLength(15);
            
            $filterBuilder->addColumn(
                $columns['cli_telefone'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
        ...
        {
            //
            // View column for cli_id field
            //
            $column = new NumberViewColumn('cli_id', 'cli_id', 'Cli Id', $this->dataset);
            ...
            $grid->AddViewColumn($column);
            //
            // View column for cli_bairro field
            //
            $column = new NumberViewColumn('cli_bairro', 'cli_bairro', 'Cli Bairro', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(0);
            $column->setThousandsSeparator(',');
            $column->setDecimalSeparator('');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('cli_bairro_edit');
            $editColumn = new CustomEditColumn('Cli Bairro', 'cli_bairro', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
