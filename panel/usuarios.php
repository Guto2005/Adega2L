    ...
    class usuariosPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->addFields(
                array(
                    ...
                    new StringField('user_login'),
                    new StringField('user_email'),
                    new StringField('user_nome'),
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'user_login', 'user_login', 'User Login'),
                new FilterColumn($this->dataset, 'user_email', 'user_email', 'User Email'),
                new FilterColumn($this->dataset, 'user_nome', 'user_nome', 'User Nome'),
        ...
        protected function setupQuickFilter(QuickFilter $quickFilter, FixedKeysArray $columns)
        {
            $quickFilter
                ...
                ->addColumn($columns['user_login'])
                ->addColumn($columns['user_email'])
                ->addColumn($columns['user_nome'])
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('user_login_edit');
            ...
            $main_editor = new TextEdit('user_nome_edit');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            // View column for user_login field
            //
            $column = new TextViewColumn('user_login', 'user_login', 'User Login', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            //
            ...
            $grid->AddViewColumn($column);
            //
            // View column for user_nome field
            //
            $column = new TextViewColumn('user_nome', 'user_nome', 'User Nome', $this->dataset);
            $column->SetOrderable(true);
        ...
        {
            //
            // Edit column for user_login field
            //
            $editor = new TextEdit('user_login_edit');
            $editor->SetMaxLength(30);
            $editColumn = new CustomEditColumn('User Login', 'user_login', $editor, $this->dataset);
            ...
            //
            // Edit column for user_nome field
            //
            $editor = new TextEdit('user_nome_edit');
            $editor->SetMaxLength(80);
            $editColumn = new CustomEditColumn('User Nome', 'user_nome', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
