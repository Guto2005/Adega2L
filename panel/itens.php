 ...
 */
    ...
    class itensPage extends Page
    {
        ...
        {
            $main_editor = new TextEdit('item_id_edit');
            ...
            $main_editor = new TextEdit('item_valor_edit');
            ...
            $main_editor = new TextEdit('item_qtd_edit');
            ...
            $main_editor = new TextEdit('item_serv_cod_edit');
            $main_editor->SetMaxLength(20);
            
            $filterBuilder->addColumn(
                $columns['item_serv_cod'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
